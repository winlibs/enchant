/* enchant.c generated by valac 0.56.19, the Vala compiler
...
{
#line 46 "enchant.vala"
	g_return_if_fail (to != NULL);
#line 47 "enchant.vala"
            ...
            const gchar* word)
{
	...
	gint _tmp2_;
	gboolean result;
#line 51 "enchant.vala"
	g_return_val_if_fail (dict != NULL, FALSE);
#line 51 "enchant.vala"
	g_return_val_if_fail (word != NULL, FALSE);
#line 52 "enchant.vala"
	_tmp1_ = strlen (word);
#line 52 "enchant.vala"
	_tmp2_ = _tmp1_;
#line 52 "enchant.vala"
...
#line 58 "enchant.vala"
		if (!terse_mode) {
#line 59 "enchant.vala"
			if (line_count > ((gsize) 0)) {
#line 60 "enchant.vala"
				g_print ("* %zu\n", line_count);
#line 314 "enchant.c"
			} else {
...
#line 378 "enchant.c"
			...
			gint _tmp7__length1;
			FILE* _tmp16_;
#line 73 "enchant.vala"
			g_print ("& ");
#line 74 "enchant.vala"
			if (line_count > ((gsize) 0)) {
#line 75 "enchant.vala"
				g_print ("%zu ", line_count);
#line 389 "enchant.c"
			}
#line 76 "enchant.vala"
			g_print ("%s", word);
#line 77 "enchant.vala"
			_tmp7_ = suggs;
#line 77 "enchant.vala"
...
do_mode_l (EnchantDict* dict,
           ...
           gsize line_count)
{
#line 91 "enchant.vala"
	g_return_if_fail (dict != NULL);
#line 91 "enchant.vala"
	g_return_if_fail (word != NULL);
#line 92 "enchant.vala"
	if (!check_word (dict, word)) {
#line 494 "enchant.c"
		FILE* _tmp0_;
...
#line 124 "enchant.vala"
						cur_byte = _tmp8_;
#line 125 "enchant.vala"
						cur_unichar += (glong) 1;
#line 976 "enchant.c"
					}
				}
#line 127 "enchant.vala"
				_tmp9_ = cur_byte;
#line 127 "enchant.vala"
				start_ptr = _tmp9_;
#line 128 "enchant.vala"
...
usage (GOptionContext* ctx)
{
	gchar* _tmp0_;
	gchar* _tmp1_;
#line 180 "enchant.vala"
	g_return_if_fail (ctx != NULL);
#line 181 "enchant.vala"
...
#line 215 "enchant.vala"
	if (main_mode == MODE_NONE) {
#line 1266 "enchant.c"
		gboolean _tmp0_ = FALSE;
#line 216 "enchant.vala"
...
#line 216 "enchant.vala"
		if (_tmp0_) {
#line 217 "enchant.vala"
			main_mode = MODE_A;
#line 1282 "enchant.c"
		} else {
			gboolean _tmp1_ = FALSE;
#line 218 "enchant.vala"
...
#line 218 "enchant.vala"
			if (_tmp1_) {
#line 219 "enchant.vala"
				main_mode = MODE_L;
#line 1299 "enchant.c"
			}
		}
	}
#line 221 "enchant.vala"
	result = TRUE;
#line 221 "enchant.vala"
	return result;
#line 1307 "enchant.c"
...
main_parse_file (FILE* fin)
{
	...
	gboolean result;
#line 224 "enchant.vala"
	g_return_val_if_fail (fin != NULL, FALSE);
#line 225 "enchant.vala"
	terse_mode = FALSE;
#line 227 "enchant.vala"
	if (main_mode == MODE_A) {
#line 1557 "enchant.c"
		FILE* _tmp0_;
#line 228 "enchant.vala"
		_tmp0_ = stdout;
#line 228 "enchant.vala"
		print_version (_tmp0_);
#line 1563 "enchant.c"
	}
#line 231 "enchant.vala"
...
#line 1580 "enchant.c"
		...
		const gchar* _tmp5_;
		const gchar* _tmp6_;
#line 234 "enchant.vala"
		_tmp4_ = enchant_get_user_language ();
#line 234 "enchant.vala"
		_g_free0 (lang);
#line 234 "enchant.vala"
		lang = _tmp4_;
#line 235 "enchant.vala"
		_tmp5_ = lang;
#line 235 "enchant.vala"
		if (_tmp5_ == NULL) {
#line 236 "enchant.vala"
			result = FALSE;
#line 236 "enchant.vala"
			_g_free0 (lang);
#line 236 "enchant.vala"
...
#line 237 "enchant.vala"
		_tmp6_ = lang;
#line 237 "enchant.vala"
		if (g_strcmp0 (_tmp6_, "C") == 0) {
#line 1607 "enchant.c"
			gchar* _tmp7_;
#line 238 "enchant.vala"
			_tmp7_ = g_strdup ("en");
#line 238 "enchant.vala"
			_g_free0 (lang);
#line 238 "enchant.vala"
...
#line 1696 "enchant.c"
		...
		FILE* _tmp114_;
#line 257 "enchant.vala"
		_tmp23_ = g_file_stream_read_line (fin);
#line 257 "enchant.vala"
		_g_free0 (str);
#line 257 "enchant.vala"
		str = _tmp23_;
...
#line 2185 "enchant.c"
				...
				__catch0_spelling:
				{
#line 267 "enchant.vala"
					g_clear_error (&_inner_error0_);
#line 336 "enchant.vala"
...
#line 361 "enchant.vala"
		_tmp114_ = stdout;
#line 361 "enchant.vala"
		fflush (_tmp114_);
#line 2391 "enchant.c"
	}
#line 364 "enchant.vala"
	result = TRUE;
#line 364 "enchant.vala"
	_g_free0 (str);
#line 364 "enchant.vala"
...
#line 374 "enchant.vala"
		_inner_error0_ = NULL;
#line 377 "enchant.vala"
		_tmp2_ = e;
#line 377 "enchant.vala"
		_tmp3_ = _tmp2_->message;
#line 377 "enchant.vala"
		g_printerr ("%s-%s: %s\n", PACKAGE, ENCHANT_MAJOR_VERSION, _tmp3_);
...
#line 2492 "enchant.c"
		FILE* _tmp5_;
#line 382 "enchant.vala"
		_tmp5_ = stdout;
#line 382 "enchant.vala"
		print_version (_tmp5_);
#line 383 "enchant.vala"
		exit (0);
#line 2500 "enchant.c"
	}
...
#line 391 "enchant.vala"
	fp = NULL;
#line 392 "enchant.vala"
	_tmp6_ = main_files;
#line 392 "enchant.vala"
	_tmp6__length1 = _vala_array_length (main_files);
#line 392 "enchant.vala"
	if (_tmp6_ == NULL) {
#line 2516 "enchant.c"
		gint _tmp7_ = 0;
		FILE* _tmp8_;
#line 393 "enchant.vala"
		_tmp8_ = stdin;
#line 393 "enchant.vala"
		if (main_parse_file (_tmp8_)) {
#line 393 "enchant.vala"
			_tmp7_ = 0;
#line 2525 "enchant.c"
		} else {
...
#line 395 "enchant.vala"
	_tmp9_ = main_files;
#line 395 "enchant.vala"
	_tmp9__length1 = _vala_array_length (main_files);
#line 2545 "enchant.c"
	{
...
#line 395 "enchant.vala"
		f_collection = _tmp9_;
#line 395 "enchant.vala"
		f_collection_length1 = _tmp9__length1;
#line 395 "enchant.vala"
...
#line 2557 "enchant.c"
			...
			gchar* f = NULL;
#line 395 "enchant.vala"
			_tmp10_ = g_strdup (f_collection[f_it]);
#line 395 "enchant.vala"
			f = _tmp10_;
#line 2564 "enchant.c"
			{
...
#line 2582 "enchant.c"
					FILE* _tmp14_;
					const gchar* _tmp15_;
#line 398 "enchant.vala"
					_tmp14_ = stderr;
#line 398 "enchant.vala"
					_tmp15_ = f;
#line 398 "enchant.vala"
					fprintf (_tmp14_, "Error: Could not open the file \"%s\" for reading.\n", _tmp15_);
